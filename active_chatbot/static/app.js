...
// import data2 from './ideas.json' assert { type: 'json' };
// console.log(data);
class Chatbox {
    constructor() {
        this.args = {
    ...
    toggleState(chatbox) {
        ...
        if (this.state) {
            ...
            if (this.messages.length === 0) {
                let msg2 = {
                    name: 'Art Teacher',
                    message: 'Hey:) I am here to help you with some drawing advices or to give you ideas if you are stuck. Feel free to ask me.'
                };
